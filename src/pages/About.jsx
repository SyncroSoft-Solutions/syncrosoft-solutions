  ...
  return (
    ...
    <section className="h-screen bg-base-100 text-base-content overflow-y-auto overflow-x-hidden scrollbar-hide">
      ...
      <div className="flex flex-wrap justify-center gap-8 sm:gap-10 px-4 sm:px-6 mb-16 sm:mb-24">
        {[{ label: "Clients", end: 120 }, { label: "Projects", end: 200 }, { label: "Team Members", end: 10 }].map((stat, i) => (
          ...
          >
            ...
            <p className="text-base-content/80 mt-1">{stat.label}</p>
          </motion.div>
        ))}
      </div>
      ...
      <motion.div
        ...
        whileInView="animate"
        viewport={{ once: true }}
        className="px-4 sm:px-6 mb-20 text-center"
      >
        <h2 className="text-2xl font-bold mb-4">Our Tech Stack</h2>
        <p className="text-base-content/80 max-w-2xl mx-auto mb-10 leading-relaxed">
          We use a combination of modern frameworks, tools, and libraries to build reliable, scalable, and visually appealing applications tailored to business needs.
        </p>
