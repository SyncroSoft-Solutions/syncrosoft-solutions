...
const RouteChanger = ({ className = "" }) => {
  ...
  // Prevent crash if path is not in routeOrder
  if (currentIndex === -1) return null;

  // Navigate to next or previous route
  ...
  return (
    // <Draggable>
      ...
      >
        <div className="backdrop-blur-3xl bg-base-200/60 shadow-xl rounded-full p-2 flex gap-3 pointer-events-auto cursor-move">
          <button
